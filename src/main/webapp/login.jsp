                            ...
                            <div id="registration-form" class="tab-pane fade">
                                <form action="${pageContext.request.contextPath}/user" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="regEmail" placeholder="Enter your email" name="regEmail" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="regPwd">Password:</label>
                                        <input type="password" class="form-control" id="regPwd" placeholder="Enter a password" name="regPwd" required>
                                    </div>
                                    <button type="submit" name="register" class="btn btn-default">Register</button>
                                </form>
                            </div>
                            <span class="errorBar">${message}</span>
                        </div>
                    </div>
                </div>
            </div>
